...
@Slf4j
@Component
public class HwCompletedHotelOrderJob extends AbstractApplicationContextJob {
    @Autowired
    ...
    public void execute(JobExecutionContext context) {
        ...
        String orderNo = jobDataMap.getString(QuartzUtil.KEY_OF_COMPLETED_ORDER_NO);
        SendVoiceDto sendVoiceDto = SendVoiceDto.builder().orderNo(orderNo).build();
        CommonResultVo<String> commonResultVo = hotelWechatApiFeignClient.completedOrderByOrderNo(sendVoiceDto);
        log.error("-----Hw Completed Hotel Order Job-------execute-----orderNo={},commonResultVo={}", orderNo, JSONObject.toJSONString(commonResultVo));
