...
@Slf4j
@Component
public class HwCloseDevicesJob extends AbstractApplicationContextJob {
    @Autowired
    ...
    public void execute(JobExecutionContext context) {
        ...
        String orderNo = jobDataMap.getString(QuartzUtil.KEY_OF_CLOSE_DEVICES);
        SendVoiceDto sendVoiceDto = SendVoiceDto.builder().orderNo(orderNo).build();

        CommonResultVo<String> commonResultVo = hotelWechatApiFeignClient.closeDevices(sendVoiceDto);
        log.error("-----Hw Close Devices Job-------execute-----sendVoiceDto={},commonResultVo={}",
