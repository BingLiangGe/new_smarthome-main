...
@Slf4j
@Component
public class HwOpenDevicesJob extends AbstractApplicationContextJob {
    @Autowired
    ...
    public void execute(JobExecutionContext context) {
        ...
        String orderNo = jobDataMap.getString(QuartzUtil.KEY_OF_OPEN_DEVICES);
        SendVoiceDto sendVoiceDto = SendVoiceDto.builder().code("16").orderNo(orderNo).build();

        CommonResultVo<String> commonResultVo = hotelWechatApiFeignClient.openDevices(sendVoiceDto);
        log.error("-----Hw Open Devices Job-------execute-----sendVoiceDto={},commonResultVo={}",
