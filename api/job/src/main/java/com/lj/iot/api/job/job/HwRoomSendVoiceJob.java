...
@Slf4j
@Component
public class HwRoomSendVoiceJob extends AbstractApplicationContextJob {
    @Autowired
    ...
    public void execute(JobExecutionContext context) {
        ...
        String orderNo = jobDataMap.getString(QuartzUtil.KEY_OF_ROOM_15_MIN_SEND_VOICE);
        SendVoiceDto sendVoiceDto = SendVoiceDto.builder().code("1").orderNo(orderNo).build();
        CommonResultVo<String> commonResultVo = hotelWechatApiFeignClient.roomSendVoice(sendVoiceDto);
        log.error("-----Hw Room Send Voice Job-------execute---sendVoiceDto={},commonResultVo={}",
