...
public class ProductController {
    ...
    public CommonResultVo<List<ProductListVo>> list() {
        return CommonResultVo.SUCCESS(bizProductService.listProductListVo());
    }
     ...
     * @return
     */
    @RequestMapping("list3326")
    public CommonResultVo<List<ProductListVo>> list3326() {
        return CommonResultVo.SUCCESS(bizProductService.listProductListVo3326());
    }
