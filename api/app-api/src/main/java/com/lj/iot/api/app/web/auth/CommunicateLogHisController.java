...
public class CommunicateLogHisController {
    ...
    @RequestMapping("page")
    public CommonResultVo<IPage<CommunicateLogHis>> list(@Valid HomeIdPageDto pageDto) {
        return CommonResultVo.SUCCESS(communicateLogHisService.customPage(pageDto, pageDto.getHomeId(), UserDto.getUser().getUId()));
    }
}
