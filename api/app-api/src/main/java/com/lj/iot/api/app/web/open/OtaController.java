...
public class OtaController {
    ...
    @GetMapping("/findChessUrl")
    public CommonResultVo<AppUpgrade> findChessUrl(long versionCode) {
        AppUpgrade appUpgrade = bizAppUpgradeService.findByVersionCode(versionCode,3);
        //目前版本最新
    ...
    public CommonResultVo<String> checkVersion(@Valid UserDeviceAddDto dto) {
        ...
        ValidUtils.isNullThrow(productUpgrade, "当前产品没有升级包");
