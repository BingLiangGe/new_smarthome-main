...
@Slf4j
@Component
public class ServiceSignalStudyReplyTopicHandler extends AbstractTopicHandler {

    public ServiceSignalStudyReplyTopicHandler() {
    ...
    public void handle(HandleMessage message) {
        ...
        final JSONObject codeData = (JSONObject) body.get("data");
