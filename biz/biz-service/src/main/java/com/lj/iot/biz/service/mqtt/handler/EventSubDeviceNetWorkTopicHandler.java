...
@Slf4j
@Component
public class EventSubDeviceNetWorkTopicHandler extends AbstractTopicHandler {

    public EventSubDeviceNetWorkTopicHandler() {
    ...
    public void handle(HandleMessage message) {
        ...
        if (userDevice != null) {
            ...
            if (StringUtils.isNotBlank(jsonObject.getString("networkKey")) && StringUtils.isNotBlank(jsonObject.getString("appKey"))){
                userDevice.setNetWorkKey(jsonObject.getString("networkKey"));
                userDevice.setDeviceKey(jsonObject.getString("appKey"));
            }
