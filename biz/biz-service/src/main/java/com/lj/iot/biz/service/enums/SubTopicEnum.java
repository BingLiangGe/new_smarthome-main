...
public enum SubTopicEnum {
    ...
    EVENT_SUB_DEVICE_TRIGGER("thing/event/topology/trigger", "", "请求场景"),
     ...
     * 节点列表
     */
    PUB_SUB_NODE_LIST("thing/event/topology/node_list", "", "节点列表"),
     ...
     * 获取设备三元组hash
     */
    EVENT_TRIGGER_SUCCESS("thing/event/topology/trigger_success", "", "离线场景执行成功"),
    ...
    SubTopicEnum(String topic, String desc) {
        this.topic = topic;
        this.desc = desc;
    }

    SubTopicEnum(String topic, String topicReplay, String desc) {
        this.topic = topic;
        this.topicReply = topicReplay;
        this.desc = desc;
    }

    public static SubTopicEnum parse(String topic) {
        for (SubTopicEnum item : SubTopicEnum.values()) {
